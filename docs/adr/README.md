...
| [0020](./0020-safety-guardrails-separate-from-evaluators.md) | Safety guardrails as a separate feature with three ABCs (vs evaluators) | Accepted | architecture, security |
