...
compliance sweeps emit multi-file findings. a predecessor project's predecessor used a
...
1. **Single dataclass, escape via `metadata`** — current a predecessor project shape
